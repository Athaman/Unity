...
public class CharacterController2D : MonoBehaviour {
	...
	void Update()
	{
		...
		else if (canDoubleJump && CrossPlatformInputManager.GetButtonDown("Jump")){// if can double jump and button pressed allow jumping
			DoJump();
			canDoubleJump= false; //disallows more double jumps until grounded again.
		}
